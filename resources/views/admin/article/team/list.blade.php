...
<div class="x-body">
    <xblock>
        <button class="layui-btn" onclick="x_admin_show('创建文章小组','{{url('admin/article/create')}}')"><i class="layui-icon"></i>创建轮播小组</button>
    ...
    <table class="layui-table">
        ...
        @foreach($data as $key=>$item)
            <tr>
                ...
                <td>{{$item->id}}</td>
                <td><a title="当前文章小组:{{$item->name}}"  onclick="x_admin_show('当前文章小组:{{$item->name}}','/admin/lunbo/list/{{$item->id}}')" href="javascript:;">{{$item->name}}</a></td>
                <td>{{$item->en_name}}</td>
